...
def build_parser() -> argparse.ArgumentParser:
    ...
    contracts.add_argument("--output", default="data/contracts_32k_prompt005/contracts.jsonl.gz")
    contracts.add_argument("--failures", default="data/contracts_32k_prompt005/failures.jsonl.gz")
    ...
    queries.add_argument("--contracts", default="data/contracts_32k_prompt005/contracts.jsonl.gz")
    queries.add_argument("--output", default="data/synthetic/single_skill_v1/queries.jsonl.gz")
    queries.add_argument("--failures", default="data/contracts_32k_prompt005/failures.jsonl.gz")
