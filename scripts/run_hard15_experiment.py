...
def parse_args(argv=None):
    ...
    parser.add_argument("--queries", type=Path, default=PROJECT_ROOT / "data/raw/evaluation_queries.jsonl")
    parser.add_argument("--rankings", type=Path, default=PROJECT_ROOT / "reports/hard/fcsr/reranker_hard.jsonl")
    parser.add_argument("--skills", type=Path, default=PROJECT_ROOT / "data/raw/skills_hard.jsonl")
